...
describe('ComponentSection', () => {
  it('should render component section', () => {
    ...
    screen.getByPlaceholderText('Supports GitHub, GitLab, and Forgejo repositories');
  ...
  it('should render git options by default', async () => {
    ...
    const source = screen.getByPlaceholderText('Supports GitHub, GitLab, and Forgejo repositories');
